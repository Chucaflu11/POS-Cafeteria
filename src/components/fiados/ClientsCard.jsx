                ...
                <div key={cliente.client_id} className={`cliente ${tarjetasAbiertas[cliente.client_id] ? 'activo' : ''}`}>
                    <div className="encabezado">
                        ...
                        {tarjetasAbiertas[cliente.client_id] && (
                            <div className="contenido">
                                ...
                                <div className="card-buttons">
                                    ...
                                    <button onClick={() => handleEditClient(cliente)}>
                                        Editar
                                    </button>
                                    {showEditClientModal && (
                                        <AddClientModal
                                            closeClientModal={closeEditClientModal}
                                            fetchData={fetchData}
                                            isEditing={true}
                        ...
                        <button className="arrow-button" onClick={() => toggleDetalles(cliente.client_id)}>
                            {tarjetasAbiertas[cliente.client_id] ? (
                                <svg className='arrow-up' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg className='arrow-down' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
